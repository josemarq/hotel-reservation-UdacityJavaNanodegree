...
public class ReservationService {
    ...
    static Reservation getNewReservation(Customer customer, IRoom room, Date checkInDate, Date checkOutDate) {
    ...
    public static Reservation reserveRoom(Customer customer, IRoom room, Date checkInDate, Date checkOutDate) {
        Reservation reservation = getNewReservation(customer, room, checkInDate, checkOutDate);
    ...
    static Collection<IRoom> getAllReservedRooms(Date checkInDate, Date checkOutDate) {
